...
export default class Home extends Component {
  ...
  render() {
    ...
    if (this.state.homeData.data) {
      sectionStyle = {
        backgroundImage:
          "url(" + this.state.homeData.data.splash_background + ")"
      };
    }
              ...
              <div className="col-md-12">
                ...
                <p>
                  <a
                    href={
                      this.state.homeData.data &&
                      this.state.homeData.data.splash_link
                    }
                    target="_blank"
                    className="btn btn-outline-white btn-lg no-"
                    data-toggle="modal"
                    data-target="#reservationModal"
                  >
                    {this.state.homeData.data &&
                      this.state.homeData.data.splash_link_text}
                  </a>
                </p>
              </div>
            </div>
